...
public class NetworkHelper
{
    ...
    public static void registerMessages()
    {
        ...
        network.registerMessage(BlockBreakTimerMessage.Handler.class, BlockBreakTimerMessage.class, id++, Side.CLIENT);
        network.registerMessage(BlockBreakTimerMessage.Handler.class, BlockBreakTimerMessage.class, id++, Side.SERVER);
